...
>(
  ...
  async (id, { rejectWithValue }) => {
    try {
      return await ServiceControllers.getServiceById(id);
    } catch (err: unknown) {
      const message =
...
>(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      await ServiceControllers.createService(payload);
      return await ServiceControllers.getAllServices();
    } catch (err: unknown) {
      const message =
...
>(
  ...
  async (payload, { rejectWithValue }) => {
    try {
      await ServiceControllers.updateService(payload);
      return await ServiceControllers.getAllServices();
    } catch (err: unknown) {
      const message =
...
>(
  ...
  async (serviceId, { rejectWithValue }) => {
    try {
      await ServiceControllers.deleteService(serviceId);
