...
export const LoginForm = () => {
  ...
  return (
    <main className="flex min-h-screen items-center bg-[#fff8ed] px-4 py-6 sm:px-6 sm:py-10 lg:block lg:px-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 lg:min-h-[calc(100vh-5rem)] lg:flex-row">
