...
interface Props {
  ...
  onChangeStatus?: (id: string, newStatus: unknown) => void;
...
function StatusDropdown({
  ...
  const handleClose = (e?: React.MouseEvent | { stopPropagation?: () => void }) => {
    e?.stopPropagation?.();
    setAnchorEl(null);
  };
  ...
  const handleCancelConfirm = (e?: React.MouseEvent | { stopPropagation?: () => void }) => {
    e?.stopPropagation?.();
    setConfirmStatus(null);
  };
