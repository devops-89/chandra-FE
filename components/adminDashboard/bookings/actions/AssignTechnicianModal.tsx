...
const AssignTechnicianModal = ({ open, booking, onClose, onAssign }: Props) => {
  ...
  const activeTechnicians = techniciansData.filter((t) => t.status === 'APPROVED');
      ...
      >
        ...
        <div className="px-6 pt-3 pb-2">
          <label className="block text-xs font-medium text-slate-600 mb-1.5">
            Assignment Note <span className="text-slate-400 font-normal">(optional)</span>
          </label>
          <textarea
            rows={2}
            value={note}
