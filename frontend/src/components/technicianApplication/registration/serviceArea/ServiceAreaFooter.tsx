  ...
  return (
    <div className="flex gap-4 justify-between p-6 bg-white rounded-xl border border-slate-400">
      <button
        onClick={onPrevious}
        type="button"
        className="flex items-center gap-2 px-6 cursor-pointer py-3 border-2 border-gray-300 text-gray-900 rounded-lg hover:bg-gray-50 transition-colors font-medium"
      >
      ...
      <button
        onClick={onSubmit}
        type="button"
        className="flex items-center cursor-pointer gap-2 px-6 py-3 bg-emerald-700 text-white rounded-lg hover:bg-emerald-800 transition-colors font-medium"
      >
