...
const HeroImage = () => {
  ...
  return (
    <div className="relative z-10 mx-auto w-full max-w-xl sm:max-w-xl lg:max-w-none">
      ...
      <div className="absolute -bottom-5 left-4 hidden rounded-2xl border border-white/80 bg-white/90 px-5 py-4 shadow-xl shadow-slate-900/10 backdrop-blur sm:left-6 lg:left-8">
